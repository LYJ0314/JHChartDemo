...
#pragma mark 重写LineChartQuardrantType的setter方法 动态改变折线图原点
/**
...
#pragma mark 重写ValueArr的setter方法 赋值时改变Y轴刻度大小
/**
    ...
    for (NSInteger m = 0;m<_valueArr.count;m++) {
        ...
        for (NSInteger i = 0 ;i<arr.count;i++ ) {
            ...
            if (p.y!=0) { // 不在X 轴上
                ...
                switch (_lineChartQuadrantType) {
                       // _xLineDataArr  x轴上的标签
                       // _valueArr      x轴上每个标签对应的峰点值
